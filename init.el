...
If SPLIT-ONEWINDOW is non-`nil' window is split in persistent action."
  ...
  (setq org-agenda-files (list "~/org/todo-personal.org" "~/org/todo-common.org" "~/org/todo-work.org"))
